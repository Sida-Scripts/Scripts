...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local minionTar = {}
local canPackets = VIP_USER and GetGameVersion and GetGameVersion():find("5.18")
...
if canPackets then
    ...
    function AggroPacket:Float(p, tbl)
        local b = {}
